package com.studios.holtzapfel.hscorelibrary.menumaker.adapters;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case IMenuItem.MENU_ITEM_TYPE_HEADER:
                return new HeaderMenuItem.HeaderViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.hs_mm_item_header, parent, false));
            case IMenuItem.MENU_ITEM_TYPE_BODY:
                return new BodyMenuItem.BodyMenuItemViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.hs_mm_item_body, parent, false));
            case IMenuItem.MENU_ITEM_TYPE_FOOTER:
                return new FooterMenuItem.FooterViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.hs_mm_item_footer, parent, false));
        }
